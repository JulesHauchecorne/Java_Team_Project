...
public class DeclarationOrdrePsy {
    public JSONObject getDeclarationJSON_EntreValide() {
        ...
        declarationJSON_EntreValide.accumulate("ordre", "psychologues");
        declarationJSON_EntreValide.accumulate("numero_de_permis", "A1234");
        declarationJSON_EntreValide.accumulate("cycle", "2016-2021");
